    ...
    <Box>
        <Box height={990} width="100%">
          ...
          <Box display="flex" flexDirection="row" justifyContent="space-evenly">
            <Box
              width={143} height={30.3} position="relative" alignItems="center" top={10}>
              <img alt="logo" src={Vector} />
              <img alt="logo" src={Igstudio} />
            </Box>

            <Box display="flex" flexDirection="row" justifyContent="space-evenly" width={431} height={26} color="#FFFFFF">
              <h4>Home</h4>
              <h4>Attorneys</h4>
          ...
          <Box  width={580} height={400}  display="flex" flexDirection="column" position="relative" top={250} left={156}>
...
<Box sx ={ {width:'438px', height :'74px' , background :'#FFFFFF', borderRadius:'43px', opacity:'10%'}}
display='flex'
